  ...
  <div class="wrapper">
    ...
    <side-bar>
      <template slot="links" slot-scope="props">
        ...
        >
          <sidebar-item :link="{ name: 'Manage Users', path: '/users' }"></sidebar-item>
          <sidebar-item
            :link="{
              name: 'My Profile',
              path: `/users/${$store.state.user.id}`
            }"
          ></sidebar-item>
        </sidebar-item>
        ...
        >
          <!-- <sidebar-item :link="{ name: 'Manage Inventory', path: '/inventory' }"></sidebar-item> -->
        </sidebar-item>
        ...
        <!-- <sidebar-item :link="{
          ...
          <sidebar-item :link="{ name: 'Manage Fields', path: '/fields/manage' }" />
          <sidebar-item :link="{ name: 'Create Fields', path: '/fields/create' }" />
      ...
      <!-- <template slot="links-after">
        ...
        <ul class="navbar-nav mb-md-3">
          <li class="nav-item">
            <a class="nav-link" href="https://demos.creative-tim.com/nuxt-argon-dashboard-pro/documentation" target="_blank" rel="noopener">
              <i class="ni ni-spaceship"></i>
              <span class="nav-link-text">Getting started</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="https://demos.creative-tim.com/nuxt-argon-dashboard-pro/documentation/foundation/colors.html" target="_blank" rel="noopener">
              <i class="ni ni-palette"></i>
              <span class="nav-link-text">Foundation</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="https://demos.creative-tim.com/nuxt-argon-dashboard-pro/documentation/components/avatars.html" target="_blank" rel="noopener">
              <i class="ni ni-ui-04"></i>
              <span class="nav-link-text">Components</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="https://demos.creative-tim.com/nuxt-argon-dashboard-pro/documentation/components/plugin_datepicker.html" target="_blank" rel="noopener">
